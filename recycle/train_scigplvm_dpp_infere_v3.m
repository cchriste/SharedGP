...
u_invGP = invGPi.pred_mean;     %u based on inverse GP
...
%     params = [params;log_l{i};log_sigma{i};log_sigma0{i};log_bta{i}];
    ...
    params_length(i+1) = 3+rank;    %number of free parameters for each GP model
end
%% main
